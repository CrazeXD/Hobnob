    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Another user with that username already exists.'}, help_text='20 characters or fewer. Letters, digits and ./_ only.', max_length=20, unique=True, validators=[Core.validators.UsernameValidator(), Core.validators.ForbiddenWordsValidator()], verbose_name='username')),
                ('password', models.CharField(max_length=128, validators=[Core.validators.PasswordValidator()], verbose_name='Password')),
                ...
                ('user_bio', models.TextField(default='', max_length=1000, validators=[Core.validators.ForbiddenWordsValidator()])),
