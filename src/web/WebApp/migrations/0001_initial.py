    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='20 characters or fewer. Letters, digits and ./_ only.', max_length=20, unique=True, validators=[WebApp.validators.UsernameValidator()], verbose_name='username')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_url', models.CharField(default='', max_length=100)),
